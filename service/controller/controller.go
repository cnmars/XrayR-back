...
func (c *Controller) Start() error {
	...
	log.Printf("[%s : %s : %d] Start monitor node status", c.clientInfo.APIHost, c.nodeInfo.NodeType, c.nodeInfo.NodeID)
	log.Println(serverstatus.GetSystemInfo())
	_ = c.nodeInfoMonitorPeriodic.Start()
	log.Printf("[%s : %s : %d] Start report node status", c.clientInfo.APIHost, c.nodeInfo.NodeType, c.nodeInfo.NodeID)
...
func (c *Controller) nodeInfoMonitor() (err error) {
	...
	if nodeInfoChanged {
		...
		log.Printf("[%s : %s : %d] %d user deleted, %d user added", c.clientInfo.APIHost, c.nodeInfo.NodeType, c.nodeInfo.NodeID, len(deleted), len(added))
...
func (c *Controller) addNewUser(userInfo *[]api.UserInfo, nodeInfo *api.NodeInfo) (err error) {
	...
	log.Printf("[%s : %s : %d] Added %d new users", c.clientInfo.APIHost, c.nodeInfo.NodeType, c.nodeInfo.NodeID, len(*userInfo))
	return nil
}
